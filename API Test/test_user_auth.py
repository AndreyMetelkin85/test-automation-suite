...
class TestUserAuth(ApiHelper):
    ...
    def setup(self):
        ...
        response1 = requests.post(url='https://playground.learnqa.ru/api/user/login',
                                  data=data)
    ...
    def test_auth_user(self):
        ...
        assert self.user_id_from_auth_method == user_id_from_check_method, "User id from auth method is not iqual to user id from check method"
    ...
    def test_negative_auth_check(self, conditions):
        ...
        assert user_id_from_check_method == 0, f"User is authorized with condition{conditions}"
